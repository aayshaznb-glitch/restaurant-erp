...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> |Restaurant ERP</title>
...
<div class="d-flex">
    ...
    <nav class="sidebar p-3 d-flex flex-column" id="sidebar">
        ...
        <ul class="nav nav-pills flex-column gap-1 flex-grow-1">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('menu-items.index')); ?>" class="nav-link <?php echo e(request()->routeIs('menu-items.*') ? 'active' : ''); ?>">
                    <i class="bi bi-egg-fried"></i> Menu Items
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('tables.index')); ?>" class="nav-link <?php echo e(request()->routeIs('tables.*') ? 'active' : ''); ?>">
            ...
            <?php if(in_array($role, ['admin','manager','kitchen'])): ?>
            <li class="nav-item">
    ...
    <div class="flex-grow-1 content-wrap">
        <nav class="navbar topbar sticky-top px-3 py-2">
            ...
            <span class="fw-semibold ms-2 ms-lg-0"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></span>
            <div class="ms-auto d-flex align-items-center gap-2">
                <?php if(auth()->guard()->check()): ?>
                <span class="badge bg-secondary badge-role text-uppercase"><?php echo e(auth()->user()->role); ?></span>
                <span class="d-none d-sm-inline text-secondary small"><?php echo e(auth()->user()->name); ?></span>
                <?php endif; ?>
            </div>
        </nav>
...
<?php /**PATH C:\Users\MSI PC\Documents\Project Order\+94 75 742 5819_Ayesha\restaurant-erp\resources\views/layouts/app.blade.php ENDPATH**/ ?>